...
const Coin: React.FC = () => {
  ...
  const {isLoading:infoLoading, data:infoData} = useQuery<CoinInfo>(["info",coinId],()=>getCoinInfo(coinId));
  const {isLoading:priceLoading, data:priceData} = useQuery<CoinPrice>(["price",coinId],()=>getCoinPriceInfo(coinId),{
